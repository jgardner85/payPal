...
public class PaymentWithCard extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
		...
		try {
			...
			APIContext context=access.getContext();
			...
			out.println("Created payment with id = " + createdPayment.getId()
					+ " and status = " + createdPayment.getState());
			out.println("RELATED RESOURCES: "+createdPayment.getTransactions().get(0).getRelatedResources());
			out.println("ER_THING: "+createdPayment);
